            ...
            <div className="space-y-3">
              <div className="rounded-3xl border border-border/80 bg-secondary/40 p-3">
                <div className="relative overflow-hidden rounded-2xl">
                  ...
                  <Button
                    type="button"
                    className="pointer-events-none h-14 w-full justify-between rounded-2xl border border-border/70 bg-background/80 px-4 text-left text-foreground hover:bg-background/80"
                    variant="outline"
                  >
                    <span className="flex items-center gap-3">
                      ...
                      <span>
                        ...
                        <span className="block text-xs text-muted-foreground">Acceso seguro a tu espacio personal</span>
                      </span>
                    </span>
